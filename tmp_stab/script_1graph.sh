...
#local
#nohup nice -n 19 julia main_epids_1graph_stab.jl ${GAMMA} ${SIG0} ${N} ${MAXITER} ${NBRUN} > fileres_epid_1graph_stab_T${T}_LAM${LAM}_GAM${GAMMA}_N${N}_iter${MAXITER}_SIG0${SIG0}_run${NBRUN} & 
